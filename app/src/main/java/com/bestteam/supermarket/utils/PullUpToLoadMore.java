...
public class PullUpToLoadMore extends ViewGroup {
    ...
    MyScrollView2 topScrollView, bottomScrollView;
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (MyScrollView2) getChildAt(0);
                bottomScrollView = (MyScrollView2) getChildAt(1);
                topScrollView.setScrollListener(new MyScrollView2.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new MyScrollView2.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
